...
This application has been build with the R-package shiny which allows the creation of interactive web application from the open-source R software.

## Utilization

We can access the web application [here](https://github-carrtel.shinyapps.io/phytool_v2)
