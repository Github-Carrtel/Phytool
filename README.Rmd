...
Phyttol_v2 is a web application allows, for phytoplankton, the homogenization between the taxonomic nomenclatures used by molecular (e.g. metabarcoding) and morphological (e.g. microscopy) approaches.
This application has been build with the R-package shiny which allows the creation of interactive web application from the open-source R sofware.

## Utilization

We can accessed to the web application [here](https://github-carrtel.shinyapps.io/phytool_v2)
